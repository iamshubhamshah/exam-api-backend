...
DashBoardRoute.get('/Students-data/:srn?/:isRegisteredBy?/:isVerified?/:grade?/:district?/:block?/:school?/:isQualifiedL1?/:L1examinationCenter?/:L2examinationCenter?/:admitCard1?', DashBoardController.GetAllStudentData);
